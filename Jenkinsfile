        ...
        stage('Push to ECR') {
            steps {
                script {
                    ...
                    def dockerTag = "${DOCKER_IMAGE_NAME}:${timestamp}"
                    ...
                    sh "docker tag ${DOCKER_IMAGE_NAME}:latest ${ECR_REPO_URL}/${DOCKER_IMAGE_NAME}:${timestamp}"
        
                    // Push the Docker image to ECR
                    sh "docker push ${ECR_REPO_URL}/${DOCKER_IMAGE_NAME}:${timestamp}"
                    }
                }
            }
        }
